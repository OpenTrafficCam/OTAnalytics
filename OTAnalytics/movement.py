...
def new_movement(ListboxMovement, movement_dict):
    ...
    add_movement = tk.Button(new_movement_creation, text="Add movement", command=lambda:
                             recieve_movement_name(movement_name_entry,
                                                   ListboxMovement,
                                                   movement_dict,
...
def add_to_movement(Listbox, ListboxMovement, linedetectors,
                    polygondetectors, movement_dict, Listbox4):
