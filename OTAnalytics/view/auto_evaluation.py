...
OUTPUT_DIR = (r"\\vs-grp08.zih.tu-dresden.de\otc_live\recordings\stationary\Dresden\Augustusbruecke_2022-09\videos\TUDCam02\Eventfiles")
#%%
...
def load_trackfile(filepath):
    ...
    print(trackfile_dic["vid_config"]["file"])
